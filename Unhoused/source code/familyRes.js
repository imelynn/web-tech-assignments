      ...
      function validateResFam()
      {
        ...
        {
          window.location.href = "familyRes.html?zip=" + zipCode; 
        }
       else
         {
      ...
      fetch(`https://api.211.org/search/v1/api/Search/Keyword?Keyword=homeless%20shelter%20family&Location=${zipCode}&Distance=100&Top=100 HTTP/1.1`, {
              method: 'GET',
              // Request headers
              headers: {
