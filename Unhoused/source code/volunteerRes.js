        ...
        fetch(`https://api.211.org/search/v1/api/Search/Keyword?Keyword=Homeless%20Shelter%20Volunteer%20Opportunities&Location=${zipCode}&Distance=100&Top=100 HTTP/1.1`, {
                method: 'GET',
                // Request headers
                headers: {
