fetch('https://api.211.org/search/v1/api/Search/Guided?TaxonomyCode=BH-1800.1500-960&Location=29304&Distance=500&Top=100&OrderBy=Relevance&SearchMode=Any HTTP/1.1', {
        method: 'GET',
        // Request headers
        headers: {
